...
forecaster \citep{cotton_timemachines}---tracks the target and returns a full predictive
distribution, and conformalizing it leaves any proper score essentially unchanged, which is
the experience the introduction describes.
...
interactive companion are available at \url{https://conformalprediction.net} and
\url{https://github.com/microprediction/conformalprediction}.
