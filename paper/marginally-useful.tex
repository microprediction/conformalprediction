...
log-score loss relative to the oracle is exactly the residual conditional-information term
$I(R;X)$ of \eqref{eq:gapA}; and the exchangeability the basic guarantee needs is typically
unavailable in deployed time-series settings. Within the single-shape residual class it is
...
precision on a heteroscedastic Gaussian and a skewed residual law. All code, figures, and
the interactive demonstrations are at \url{https://conformalprediction.net} (source:
