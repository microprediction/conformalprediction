# Conformal Prediction Provides a Rigorous Guarantee ... That You'll Lose Money Leaning on It
...
People who bet are not going to be fooled by conformal prediction as a brand because from this last perspective it is akin to changing the *overround*, the house’s cut. If you are the house and you can do that, good for you. But a bad bookmaker is not safe even if they set their overround to the point where horses' odds add up to 200% (if there are three horses, that is). Your only truly safe option is to offer "money back" on each horse if it wins, and why anyone would take that bet is beyond me. 

That sounds ridiculous until you realize it is essentially the kind of blowups you see in the no-go theorems surrounding variants of conformal prediction. The intervals have to explode. Unless you *really* just need the actual interval guarantee because you are in robotics or something, conformal prediction's largely useless guarantee cannot be easily mended.  
