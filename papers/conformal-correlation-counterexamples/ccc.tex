...
The proposition also disposes of the claim that the entries ``incorporate the entire distribution
...
Proposition~\ref{prop:law} it sees only the law of the sets, by Proposition~\ref{prop:any} the
