...
similarity, confusion and client quality are read off. A marginal conformal object costs exactly
the conditional information it discards \citep{cotton2026}, and the same accounting applies to the
sets. We give a specific caution in the form of a no-go theorem and a one bit calculation: no
