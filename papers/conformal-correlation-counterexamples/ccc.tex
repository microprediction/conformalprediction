...
similarity, confusion and client quality are read off. The more recent information gap identity of
\citet{cotton2026}, that a marginal conformal object costs exactly the conditional information it
discards, applies to the sets as well. We give a specific caution in the form of a no-go theorem and a one bit calculation: no
