...
\begin{abstract}
\citet{perlo2026} correlate the membership indicators of conformal prediction sets and read the
result as a map of which classes a classifier confuses. It is not. Two classifiers built inside
