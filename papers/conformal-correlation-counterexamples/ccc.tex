...
similarity, confusion and client quality are read off, without heed to the warning in
\citet{cotton2026} that a marginal conformal object costs exactly the conditional information it
discards. We give a specific caution in the form of a no-go theorem and a one bit calculation: no
