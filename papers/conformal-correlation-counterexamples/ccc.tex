...
all four entries. Outside such cases the theorem applies, and Example~\ref{ex:aps} shows that its two
laws can both be realized by randomized APS classifiers.
...
Coverage is the same for both models too, and it is worth stating carefully. Conditional on the
calibration sample, coverage equals $r$ exactly. Since $\tau$ is the $k$-th smallest of $m$ uniforms
...
Theorem~\ref{thm:nogo} no statistic of the sets, this one or any other, determines the confusion
matrix once a set of size two occurs.
