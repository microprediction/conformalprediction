...
$\operatorname{Var}(Z_{(k)})=v_k+\rho(1-v_k)$. The general single-level negative-association
contraction is left as a conjecture, supported numerically. The governing sign is the one the
companion note attaches to the finite de Finetti measure.
\end{abstract}
