...
independent value throughout $\rho<0$ (\texttt{check\_fan.py}); the only gap to the uniform-marginal
conjecture is that the monotone map $\Phi$ preserve the contraction, a dispersive-order transfer.
\end{remark}
