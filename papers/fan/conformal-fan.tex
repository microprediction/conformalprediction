...
be false: an explicit negatively associated law, uniform marginals, over-disperses an order
statistic at every $n$, and full support does not rescue it (a strictly-positive-density,
strictly-interior-NA law violates too, certified exactly). The bound does hold on the structured
subclasses a calibration design produces --- Gaussian-copula, FGM, and without-replacement ---
which we prove.
\end{abstract}
...
Degeneracy is not the escape either. One might hope the failure needs the counterexample's vanishing
