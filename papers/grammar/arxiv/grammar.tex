...
operator among peers. Interpolated, it is invertible. On distinct exchangeable input
it is exactly calibrated at its retained levels, within one knot cell everywhere,
while its slope guard sleeps. The certificate covers the operator's output, nothing downstream.
