...
guard sleeps. Two honest guards are implemented as options. Deleting offending knots restores
exact order statistics at an enlarged $\Delta_n$. Searching for the smallest rank
displacement the budget admits, and projecting the knots into that corridor, pays
exactly $\Delta_n + e/(n+1)$, the least possible: on this counterexample $e = 6$,
with thirty-five of the thirty-nine knots untouched and the worst segment exactly at
the cap. On the campaign corpus both are indistinguishable from the moving cap,
identical on ninety-seven percent of series with mean differences under $0.0003$
