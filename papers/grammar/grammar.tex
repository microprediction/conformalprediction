...
learner-input channel stays active inside each expert, as everywhere in the paper. The runner also resets the mixture weights to
...
however long the series run, and the realized comparison sits on the profitable
side of it. Nothing
