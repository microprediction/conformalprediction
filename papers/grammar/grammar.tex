...
the \texttt{benchmarks} directory of the \texttt{skaters} repository. The original
run is \texttt{gaussianize\_chain.py}, frozen in \texttt{gaussianize\_chain.csv},
and it also produces the synthetic warp numbers. The campaign runner is described at the end of this appendix. The
